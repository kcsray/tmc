...
$sql = "DELETE FROM tmc_migrants  WHERE id = :id  and tmc_cd = :tmc_cd";
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <div class="alert alert-danger fade in">
                                <input type="hidden" name="id" value="<?php echo trim($_GET["mcode"]); ?>"/>
                                <input type="hidden" name="tmc_cd" value="<?php echo trim($_GET["tmc_cd"]); ?>"/>
                                <p>Are you sure you want to Delete Premanently this Record ?</p><br>
                                <p>
                                    <input type="submit" value="Yes" class="btn btn-danger">
                                    <a href="MigrantBlock2tmc.php" class="btn btn-default">No</a>
                                </p>
                            </div>
                        </form>
                    </div>
