...
if( $_SESSION["role"] !=='R'  && $_SESSION["role"] !=='U'  ){
...
header("location: welcome_tmcblk.php");
exit();
} else{
  ...
  <body>
    <div class="wrapper">
      <div class="page-header">
        ...
        <h6  class="text-danger text-center"> Migrants to TMC of Bock</h6>
        <h2  class="text-primary text-center"> <?php echo $_SESSION["username"] ?> </h2>
      </div>
